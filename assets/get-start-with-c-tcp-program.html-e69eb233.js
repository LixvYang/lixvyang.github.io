import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{o as a,c as e,e as t}from"./app-c92d5405.js";const p="/assets/images/tcp/tcp.png",c={};function o(i,n){return a(),e("div",null,n[0]||(n[0]=[t('<h1 id="tcp-ip-network-program" tabindex="-1"><a class="header-anchor" href="#tcp-ip-network-program" aria-hidden="true">#</a> TCP/IP Network Program</h1><p>If you are learn TCP/IP network, you must have heard that CS model with this.</p><figure><img src="'+p+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>But if you are new with network programing, there are difficult.</p><p>This is a tutor try to help you to know network programing simply.</p><p>The first of all, you have to gcc env.</p><p>Input <code>gcc --version</code> on your shell.</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ gcc <span class="token parameter variable">--version</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>This tutorial is over, but network programming is just beginning Good luck</p>`,37)]))}const u=s(c,[["render",o],["__file","get-start-with-c-tcp-program.html.vue"]]);export{u as default};
