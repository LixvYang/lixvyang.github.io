...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h2><p>中介者模式是一种将对象之间的交互封装到一个中心对象的设计模式，它可以简化对象之间的通信，降低系统的耦合度，提高系统的可维护性和可扩展性。中介者模式适用于对象之间的交互方式复杂且难以理解，或者需要在运行时动态地改变对象之间的交互方式的场景。</p>`,12))])}const k=s(o,[["render",i],["__file","Mediator.html.vue"]]);export{k as default};
