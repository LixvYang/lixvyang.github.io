import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{o as a,c as e,b as t,f as p,e as i}from"./app-a54f0d90.js";const c={};function o(l,n){return a(),e("div",null,[n[0]||(n[0]=t("p",null,"在软件开发中，经常会遇到需要保证系统中只有一个对象的情况。这种情况下，可以使用单例模式来解决问题。本文将介绍单例模式的定义、用处、实现方法和区别，并通过一个示例程序来说明其应用。",-1)),p(" more "),n[1]||(n[1]=i(`<h1 id="单例模式" tabindex="-1"><a class="header-anchor" href="#单例模式" aria-hidden="true">#</a> 单例模式</h1><h2 id="定义" tabindex="-1"><a class="header-anchor" href="#定义" aria-hidden="true">#</a> 定义</h2><p>单例模式是一种创建型设计模式，其目的是确保系统中只有一个对象，并提供了一个全局访问点来访问该对象。单例模式通常用于管理系统资源，如数据库连接池、日志记录器等。</p><p>我们的实现可以采用饿汉和懒汉的方式来实现:</p><h2 id="用处" tabindex="-1"><a class="header-anchor" href="#用处" aria-hidden="true">#</a> 用处</h2><p>单例模式的主要用处包括：</p><ul><li>保证系统中只有一个对象，从而节省内存空间和提高性能。</li><li>提供了一个全局访问点，使得系统中的其他对象可以访问该对象。</li><li>可以方便地控制对象的生命周期，如初始化、销毁等。</li></ul><h2 id="实现" tabindex="-1"><a class="header-anchor" href="#实现" aria-hidden="true">#</a> 实现</h2><h3 id="饿汉式" tabindex="-1"><a class="header-anchor" href="#饿汉式" aria-hidden="true">#</a> 饿汉式</h3><p>饿汉式单例模式是指在类加载时就立即创建对象，并将其存储在静态变量中。这种方式的好处是线程安全，但是缺点是不能够延迟对象的创建，可能会造成资源浪费。</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">type</span> Singleton <span class="token keyword">struct</span><span class="token punctuation">{</span><span class="token punctuation">}</span>
