import{_ as o}from"./plugin-vue_export-helper-c27b6911.js";import{r as p,o as i,c as l,b as s,d as n,a as e,e as t}from"./app-b432f07b.js";const c={},u=t(`<h1 id="grpc教程-2-grpc下载以及入门grpc" tabindex="-1"><a class="header-anchor" href="#grpc教程-2-grpc下载以及入门grpc" aria-hidden="true">#</a> GRPC教程 2- gRPC下载以及入门gRPC</h1><div class="hint-container info"><p class="hint-container-title">相关信息</p><p>本篇文章我们开始学习gRPC，我们之前学到了RPC(远程过程调用)，那么gRPC是什么呢？gRPC是Google开源的现代高性能RPC框架，能够运行在任何环境中，使用HTTP2作为传输协议。</p><p>gRPC与RPC一样，可以像调用本地方法一样去调用另一个进程上的服务，这可以帮助你很轻松的创建微服务程序。gRPC只是定义类型和远程服务带有的参数和返回类型，我们需要在gRPC服务端程序中定义服务的逻辑，在客户端调用和服务器端相同的方法。</p></div><h2 id="安装grpc" tabindex="-1"><a class="header-anchor" href="#安装grpc" aria-hidden="true">#</a> 安装gRPC</h2><ol><li>安装Protocol Buffers</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>https://github.com/google/protobuf/releases
