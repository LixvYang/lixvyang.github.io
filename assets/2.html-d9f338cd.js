import{_ as p}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o as l,c,e as t,b as s,d as a,a as o}from"./app-7abc0186.js";const u={},r={start:"3"},d={href:"https://grpc.io",target:"_blank",rel:"noopener noreferrer"},v={href:"https://grpc.io/docs/languages/go/quickstart/",target:"_blank",rel:"noopener noreferrer"};function k(m,n){const e=i("ExternalLinkIcon");return l(),c("div",null,[n[6]||(n[6]=t(`<h1 id="grpc教程-2-grpc下载以及入门grpc" tabindex="-1"><a class="header-anchor" href="#grpc教程-2-grpc下载以及入门grpc" aria-hidden="true">#</a> GRPC教程 2- gRPC下载以及入门gRPC</h1><div class="hint-container info"><p class="hint-container-title">相关信息</p><p>本篇文章我们开始学习gRPC，我们之前学到了RPC(远程过程调用)，那么gRPC是什么呢？gRPC是Google开源的现代高性能RPC框架，能够运行在任何环境中，使用HTTP2作为传输协议。</p><p>gRPC与RPC一样，可以像调用本地方法一样去调用另一个进程上的服务，这可以帮助你很轻松的创建微服务程序。gRPC只是定义类型和远程服务带有的参数和返回类型，我们需要在gRPC服务端程序中定义服务的逻辑，在客户端调用和服务器端相同的方法。</p></div><h2 id="安装grpc" tabindex="-1"><a class="header-anchor" href="#安装grpc" aria-hidden="true">#</a> 安装gRPC</h2><ol><li>安装Protocol Buffers</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>https://github.com/google/protobuf/releases
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>将 protoc下的 bin目录下的 <code>protoc</code>文件加入到<code>$GOPATH/bin</code>目录下， 然后将include目录 放到<code>$GOPATH</code> 目录下，以便于我们编写proto文件时，可以找到对应的文件。</p>`,10)),s("ol",r,[s("li",null,[n[2]||(n[2]=a("下载protobuf go语言的插件",-1)),n[3]||(n[3]=s("br",null,null,-1)),n[4]||(n[4]=a(" 进入 ",-1)),s("a",d,[n[0]||(n[0]=a("https://grpc.io",-1)),o(e)]),n[5]||(n[5]=a(" , 点击 go 进入",-1)),s("a",v,[n[1]||(n[1]=a("https://grpc.io/docs/languages/go/quickstart/",-1)),o(e)])])]),n[7]||(n[7]=t(`<p>开始下载go的插件</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>go install google.golang.org/protobuf/cmd/protoc-gen-go@v1.28 // 生成 .pb.go文件
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>接下来在这两个目录下都创建一个proto文件夹。<br> 首先然后在server/proto文件夹下创建一个hello.proto,在client/proto文件夹下创建一个hello.proto文件。</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token comment">// server/proto/hello.proto</span>
...
开始编写gRPC的相关代码
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,22))])}const f=p(u,[["render",k],["__file","2.html.vue"]]);export{f as default};
