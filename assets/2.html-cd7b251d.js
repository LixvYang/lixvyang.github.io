import{_ as o}from"./plugin-vue_export-helper-c27b6911.js";import{r as p,o as i,c as l,b as s,d as n,a as e,e as t}from"./app-cec75bf3.js";const c={},u=t(`<h1 id="grpc教程-2-grpc下载以及入门grpc" tabindex="-1"><a class="header-anchor" href="#grpc教程-2-grpc下载以及入门grpc" aria-hidden="true">#</a> GRPC教程 2- gRPC下载以及入门gRPC</h1><div class="hint-container info"><p class="hint-container-title">相关信息</p><p>本篇文章我们开始学习gRPC，我们之前学到了RPC(远程过程调用)，那么gRPC是什么呢？gRPC是Google开源的现代高性能RPC框架，能够运行在任何环境中，使用HTTP2作为传输协议。</p><p>gRPC与RPC一样，可以像调用本地方法一样去调用另一个进程上的服务，这可以帮助你很轻松的创建微服务程序。gRPC只是定义类型和远程服务带有的参数和返回类型，我们需要在gRPC服务端程序中定义服务的逻辑，在客户端调用和服务器端相同的方法。</p></div><h2 id="安装grpc" tabindex="-1"><a class="header-anchor" href="#安装grpc" aria-hidden="true">#</a> 安装gRPC</h2><ol><li>安装Protocol Buffers</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>https://github.com/google/protobuf/releases
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>将 protoc下的 bin目录下的 <code>protoc</code>文件加入到<code>$GOPATH/bin</code>目录下， 然后将include目录 放到<code>$GOPATH</code> 目录下，以便于我们编写proto文件时，可以找到对应的文件。</p>`,10),r={start:"3"},d=s("br",null,null,-1),v={href:"https://grpc.io",target:"_blank",rel:"noopener noreferrer"},k={href:"https://grpc.io/docs/languages/go/quickstart/",target:"_blank",rel:"noopener noreferrer"},m=t(`<p>开始下载go的插件</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>go install google.golang.org/protobuf/cmd/protoc-gen-go@v1.28 // 生成 .pb.go文件
...
开始编写gRPC的相关代码
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,22);function g(b,h){const a=p("ExternalLinkIcon");return i(),l("div",null,[u,s("ol",r,[s("li",null,[n("下载protobuf go语言的插件"),d,n(" 进入 "),s("a",v,[n("https://grpc.io"),e(a)]),n(" , 点击 go 进入"),s("a",k,[n("https://grpc.io/docs/languages/go/quickstart/"),e(a)])])]),m])}const x=o(c,[["render",g],["__file","2.html.vue"]]);export{x as default};
