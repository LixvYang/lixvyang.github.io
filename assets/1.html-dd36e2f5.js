import{_ as n,o as s,c as a,e as t}from"./app-927a6ce5.js";const p={},e=t(`<h1 id="grpc教程-1-go语言原生rpc原理" tabindex="-1"><a class="header-anchor" href="#grpc教程-1-go语言原生rpc原理" aria-hidden="true">#</a> GRPC教程 1- Go语言原生RPC原理</h1><p>::: info 本篇文章介绍一下RPC的概念以及在Go语言如何使用标准库中的RPC.</p><p>RPC是全称叫Remote Procedure Call，远程过程调用，它允许像调用本地服务一样去调用远程服务，相对应的就是本地调用。 :::</p><p>本地调用的例子:</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> main
