import{_ as p}from"./plugin-vue_export-helper-c27b6911.js";import{r as o,o as i,c,f as l,b as n,d as s,a as t,e}from"./app-146edfe9.js";const u={},r=n("p",null,"NextJs是目前最流行的 FullStack FrameWork 之一，它提供了一套完整的开发体验，包括服务端渲染、API路由、数据管理、路由管理等。",-1),d=n("p",null,"于是在 NextJs 之上就会有许多插件系统帮助我们实现各种功能，其中就包括 NextAuth。",-1),k=n("p",null,"NextAuth 是 NextJs 的一个插件，它可以帮助你实现用户认证、授权、管理等功能。",-1),v=n("p",null,"本文将介绍 NextAuth 的基本用法，以及如何集成到 NextJs 项目中。",-1),m=n("h1",{id:"nextauth-学习笔记",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#nextauth-学习笔记","aria-hidden":"true"},"#"),s(" NextAuth 学习笔记")],-1),b={href:"https://github.com/nextauthjs/next-auth",target:"_blank",rel:"noopener noreferrer"},h={href:"https://mixin.one/",target:"_blank",rel:"noopener noreferrer"},g={href:"https://create.t3.gg/",target:"_blank",rel:"noopener noreferrer"},x=n("code",null,"prisma",-1),_=n("code",null,"next-auth",-1),f=n("code",null,"dotenv",-1),y=n("code",null,"TailwindCSS",-1),w=e(`<p>所以我们后续使用T3-App快速搭建项目后，将着重点放在NextAuth的使用上。</p><h2 id="快速搭建t3-app项目" tabindex="-1"><a class="header-anchor" href="#快速搭建t3-app项目" aria-hidden="true">#</a> 快速搭建T3-App项目</h2><p>根据t3-app的文档，我们可以快速搭建一个NextJs项目，这里我们使用T3-App快速搭建项目。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">pnpm</span> create t3-app@latest
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,37),q={href:"https://github.com/nextauthjs/next-auth/discussions/562#discussioncomment-6589689",target:"_blank",rel:"noopener noreferrer"},E=e(`<div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> PrismaAdapter <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;@next-auth/prisma-adapter&#39;</span><span class="token punctuation">;</span>
...
<span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Mixin登录用户的所有信息都可以通过这个provider获取到，包括id、name、image等，注意Mixin用户没有Email。</p><p>基于角色的管理也比较重要，如果你的控制台需要角色去管理的话。</p><h3 id="接入-web3-登录" tabindex="-1"><a class="header-anchor" href="#接入-web3-登录" aria-hidden="true">#</a> 接入 Web3 登录</h3>`,7),S={href:"https://github.com/DakaiGroup/nextjs-nextauth-metamask/",target:"_blank",rel:"noopener noreferrer"},A=n("h4",{id:"solana-登录",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#solana-登录","aria-hidden":"true"},"#"),s(" Solana 登录")],-1),I={href:"https://www.quicknode.com/guides/solana-development/dapps/how-to-authenticate-users-with-a-solana-wallet#overview",target:"_blank",rel:"noopener noreferrer"},N=e(`<h4 id="eth-登录" tabindex="-1"><a class="header-anchor" href="#eth-登录" aria-hidden="true">#</a> Eth 登录</h4><h3 id="添加session会话" tabindex="-1"><a class="header-anchor" href="#添加session会话" aria-hidden="true">#</a> 添加Session会话</h3><p>你需要添加SessionProvider来存储Session信息，以便于客户端代码可以获取session信息。</p><p>于是你就可以保护你的API路由了，只允许登录用户访问。</p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">// middleware中控制的不区分客户端/服务端组件</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="基于角色的认证" tabindex="-1"><a class="header-anchor" href="#基于角色的认证" aria-hidden="true">#</a> 基于角色的认证</h3>`,6),T={href:"https://authjs.dev/guides/role-based-access-control",target:"_blank",rel:"noopener noreferrer"},R=e(`<div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">// middleware/config</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里也是有点问题，一个已经登录的用户访问 /admin authorized返回 false,会重定向到sign in 界面，所以实际上在sign in 页面需要检测session 判断是否用户已经登录，如果已经登录则重定向到首页即可。或者直接在middleware中执行页面跳转。</p>`,2);function C(L,D){const a=o("ExternalLinkIcon");return i(),c("div",null,[r,d,k,v,l(" more "),m,n("p",null,[s("本文是我在使用NextAuth过程中,尝试使用 JWT Token 使用方式, 尝试使用 Prisma ORM 框架, 尝试使用 "),n("a",b,[s("Github"),t(a)]),s("/"),n("a",h,[s("Mixin"),t(a)]),s("第三方登录/Email(Resent)后总结而来的学习笔记。")]),n("p",null,[s("使用"),n("a",g,[s("T3-App"),t(a)]),s("快速搭建NextJs项目, 简单来说T3-App是一个NextJs的脚手架，比如之前使用NextJs的方式是安装了NextJs，接着需要安装"),x,s("、"),_,s("、"),f,s("、"),y,s("等等依赖服务，于是T3-App可以帮助你节省这些时间，T3-App会自动帮你安装这些依赖，并且配置好项目。")]),w,n("p",null,[s("但是这样的话，email用户每次登录都没有对应的名称，我们可以覆盖prisma db原有的createUser方法，在创建用户时，将用户的name和email一起创建到数据库中,"),n("a",q,[s("解决方案"),t(a)]),s(":")]),E,n("p",null,[n("a",S,[s("NextAuth ETH灯枯教程"),t(a)])]),A,n("p",null,[n("a",I,[s("NextAuth Solana登录教程"),t(a)])]),N,n("p",null,[n("a",T,[s("文档地址"),t(a)])]),R])}const P=p(u,[["render",C],["__file","next-auth-js.html.vue"]]);export{P as default};
