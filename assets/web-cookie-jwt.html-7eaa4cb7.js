import{_ as o}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o as c,c as u,b as s,f as l,e as p,d as a,a as e}from"./app-a54f0d90.js";const r="/assets/images/program/cookie-jwt/cookie-session.png",k="/assets/images/program/cookie-jwt/token.png",d={},v={href:"https://tools.ietf.org/html/rfc7519",target:"_blank",rel:"noopener noreferrer"},m={href:"https://jwt.io/",target:"_blank",rel:"noopener noreferrer"};function b(g,n){const t=i("ExternalLinkIcon");return c(),u("div",null,[n[5]||(n[5]=s("p",null,"众所周知，HTTP协议是无状态协议，在一次请求过后，下一次服务器就不知道这个请求是谁发送过来的了，在Web应用中，用户的认证和鉴权是非常重要的一环，实践有多种可用方案，并且各有千秋。",-1)),l(" more "),n[6]||(n[6]=p('<h1 id="cookie-jwt-学习" tabindex="-1"><a class="header-anchor" href="#cookie-jwt-学习" aria-hidden="true">#</a> Cookie &amp; JWT 学习</h1><h2 id="cookie-session-认证" tabindex="-1"><a class="header-anchor" href="#cookie-session-认证" aria-hidden="true">#</a> Cookie-Session 认证</h2><p>在Web应用发展初期至目前依然有很多网站采用Cookie-Session的方案来管理用户认证的逻辑：</p><ol><li>客户端通过用户名密码/第三方登录进行认证</li><li>认证成功后，在服务器端生成对应的session，然后将sessionID通过HTTP响应头Cookie发送给客户端</li><li>客户端访问需要认证的接口时，在Cookie中携带对应的SessionID</li><li>服务端根据对应的SessionID查找Session并进行鉴权 返回给客户端需要的数据</li></ol><figure><img src="'+r+`" alt="cookie-session.png" tabindex="0" loading="lazy"><figcaption>cookie-session.png</figcaption></figure><p>Golang代码实现:</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> main
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,26))])}const h=o(d,[["render",b],["__file","web-cookie-jwt.html.vue"]]);export{h as default};
