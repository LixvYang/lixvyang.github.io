...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="基于角色的认证" tabindex="-1"><a class="header-anchor" href="#基于角色的认证" aria-hidden="true">#</a> 基于角色的认证</h3>`,11),S={href:"https://authjs.dev/guides/role-based-access-control",target:"_blank",rel:"noopener noreferrer"},A=e(`<div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">// middleware/config</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里也是有点问题，一个已经登录的用户访问 /admin authorized返回 false,会重定向到sign in 界面，所以实际上在sign in 页面需要检测session 判断是否用户已经登录，如果已经登录则重定向到首页即可。或者直接在middleware中执行页面跳转。</p>`,2);function I(N,T){const a=o("ExternalLinkIcon");return i(),c("div",null,[r,d,k,v,l(" more "),m,n("p",null,[s("本文是我在使用NextAuth过程中,尝试使用 JWT Token 使用方式, 尝试使用 Prisma ORM 框架, 尝试使用 "),n("a",b,[s("Github"),t(a)]),s("/"),n("a",h,[s("Mixin"),t(a)]),s("第三方登录/Email(Resent)后总结而来的学习笔记。")]),n("p",null,[s("使用"),n("a",g,[s("T3-App"),t(a)]),s("快速搭建NextJs项目, 简单来说T3-App是一个NextJs的脚手架，比如之前使用NextJs的方式是安装了NextJs，接着需要安装"),x,s("、"),_,s("、"),f,s("、"),y,s("等等依赖服务，于是T3-App可以帮助你节省这些时间，T3-App会自动帮你安装这些依赖，并且配置好项目。")]),q,n("p",null,[s("但是这样的话，email用户每次登录都没有对应的名称，我们可以覆盖prisma db原有的createUser方法，在创建用户时，将用户的name和email一起创建到数据库中,"),n("a",w,[s("解决方案"),t(a)]),s(":")]),E,n("p",null,[n("a",S,[s("文档地址"),t(a)])]),A])}const L=p(u,[["render",I],["__file","next-auth-js.html.vue"]]);export{L as default};
