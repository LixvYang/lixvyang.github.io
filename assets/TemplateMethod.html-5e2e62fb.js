import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,f as t,b as e,e as p}from"./app-4f942940.js";const c={},o=e("p",null,"模板方法模式是一种行为型设计模式，它定义了一个算法的骨架，将一些步骤延迟到子类中实现。模板方法模式可以让子类在不改变算法结构的情况下，重新定义算法的某些步骤。",-1),i=p(`<h1 id="模版模式" tabindex="-1"><a class="header-anchor" href="#模版模式" aria-hidden="true">#</a> 模版模式</h1><p>当你希望在某个算法中的特定点上提供挂钩，以便其他人可以扩展该算法而无需更改其结构时，可以使用模板方法模式。</p><h2 id="用法" tabindex="-1"><a class="header-anchor" href="#用法" aria-hidden="true">#</a> 用法</h2><ul><li>代码复用：你可以将相同的代码放在超类的一个公共方法中。</li><li>扩展性：子类可以通过重写部分算法来实现新的行为。</li><li>控制：父类可以控制子类的执行顺序。</li></ul><h2 id="示例" tabindex="-1"><a class="header-anchor" href="#示例" aria-hidden="true">#</a> 示例</h2><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> main
