...
10 - 5 = 5
10 * 5 = 50
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h2><p>策略模式是一种将算法封装在不同的策略类中，并使它们可以互相替换的设计模式，它可以实现对象在运行时根据不同的条件选择不同的算法来完成相同的功能。策略模式适用于对象有多种行为，或者一个算法有多种实现方式的场景。</p>`,12);function l(u,r){return s(),a("div",null,[o,t(" more "),i])}const m=n(c,[["render",l],["__file","Strategy.html.vue"]]);export{m as default};
