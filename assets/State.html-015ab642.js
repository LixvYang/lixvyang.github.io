import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as p,o,c,b as s,f as i,d as a,a as l,w as u,e as r}from"./app-468a2905.js";const d={};function k(m,n){const t=p("RouterLink");return o(),c("div",null,[n[2]||(n[2]=s("p",null,"状态模式是一种行为型设计模式，它允许一个对象在其内部状态改变时，改变其行为。状态模式将对象的状态和行为分离，使得对象可以在运行时切换不同的状态，从而实现不同的行为。",-1)),i(" more "),n[3]||(n[3]=s("h1",{id:"状态模式",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#状态模式","aria-hidden":"true"},"#"),a(" 状态模式")],-1)),s("p",null,[n[1]||(n[1]=a("你可以读一读有限状态机这篇文章更详细了解状态模式")),l(t,{to:"/posts/program/golang/%E5%B8%B8%E7%94%A8%E6%A1%86%E6%9E%B6%E5%B7%A5%E5%85%B7/common/fsm.html"},{default:u(()=>n[0]||(n[0]=[a("有限状态机")])),_:1,__:[0]})]),n[4]||(n[4]=r(`<p>状态模式的用法有以下几种：</p><ul><li>当一个对象的行为取决于其状态，并且它需要在运行时根据状态改变其行为时，可以使用状态模式。</li><li>当一个对象有多个状态，而且这些状态之间的转换逻辑复杂时，可以使用状态模式来管理这些状态和转换逻辑。</li><li>当一个对象的操作有多个分支，每个分支依赖于该对象的状态时，可以使用状态模式来消除冗余的条件分支语句。</li></ul><p>状态模式的优点有以下几种：</p><ul><li>状态模式可以实现对象状态和行为的封装，提高了代码的可读性和可维护性。</li><li>状态模式可以实现对象状态和行为的动态切换，增加了对象的灵活性和扩展性。</li><li>状态模式可以避免使用大量的条件分支语句，降低了代码的复杂度和出错率。</li></ul><h2 id="用法" tabindex="-1"><a class="header-anchor" href="#用法" aria-hidden="true">#</a> 用法</h2><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token comment">// 定义抽象状态类</span>
