import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{o as a,c as t,b as e,f as p,e as c}from"./app-468a2905.js";const o={};function i(l,n){return a(),t("div",null,[n[0]||(n[0]=e("p",null,"观察者模式是一种行为型设计模式，它定义了一种一对多的依赖关系，让多个观察者对象同时监听某一个主题对象，当主题对象的状态发生变化时，它会通知所有观察者对象，使它们能够自动更新自己。",-1)),p(" more "),n[1]||(n[1]=c(`<h1 id="观察者模式" tabindex="-1"><a class="header-anchor" href="#观察者模式" aria-hidden="true">#</a> 观察者模式</h1><h2 id="用法" tabindex="-1"><a class="header-anchor" href="#用法" aria-hidden="true">#</a> 用法</h2><p>观察者模式的用法有以下几种：</p><ul><li>当一个对象的状态需要被其他对象实时关注时，可以使用观察者模式。</li><li>当一个对象需要通知其他对象，而又不想与其他对象产生紧密的耦合时，可以使用观察者模式。</li><li>当一个抽象模型有两个方面，其中一个方面依赖于另一个方面，可以将这两个方面封装在独立的对象中，使它们可以各自独立地改变和复用时，可以使用观察者模式。</li></ul><p>观察者模式的优点有以下几种：</p><ul><li>观察者模式可以实现对象之间的动态联动，实现数据的实时更新和同步。</li><li>观察者模式可以实现对象之间的松耦合，增强对象的重用性和独立性。</li><li>观察者模式可以实现抽象层的封装，隐藏了主题对象和观察者对象之间的具体实现细节。</li></ul><h2 id="示例" tabindex="-1"><a class="header-anchor" href="#示例" aria-hidden="true">#</a> 示例</h2><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token comment">// 定义抽象主题类</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h2><p>观察者模式是一种将对象状态的变化通知给其他对象的设计模式，它可以实现对象之间的动态联动，实现数据的实时更新和同步。观察者模式适用于对象状态需要被其他对象实时关注，或者需要通知其他对象，而又不想与其他对象产生紧密的耦合的场景。</p>`,12))])}const k=s(o,[["render",i],["__file","Observer.html.vue"]]);export{k as default};
