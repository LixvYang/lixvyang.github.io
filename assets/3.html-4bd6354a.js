...
GRPC对比WebSocket
GRPC的错误处理
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,9);function v(m,b){const t=e("ExternalLinkIcon");return o(),c("div",null,[u,s("p",null,[n("GRPC自己定义了一些常见的错误码，和我们可以在"),s("a",r,[n("codes"),i(t)]),n("找到。"),k,n(" 需要使用时，需要引入codes包")]),d])}const w=p(l,[["render",v],["__file","3.html.vue"]]);export{w as default};
