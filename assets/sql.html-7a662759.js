import{_ as p}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as t,c as r,f as c,b as s,d as n,a as e,e as o}from"./app-584b6577.js";const i={},d=s("p",null,"SQL是后端程序员经常会打交道的语句，但是很惭愧，我只是在工作中用到，并没有精通熟悉，这篇文章主要记录我SQL一些不熟悉的地方。",-1),k=o('<h1 id="sql-熟练使用" tabindex="-1"><a class="header-anchor" href="#sql-熟练使用" aria-hidden="true">#</a> SQL 熟练使用</h1><h4 id="内连接和外连接的区别" tabindex="-1"><a class="header-anchor" href="#内连接和外连接的区别" aria-hidden="true">#</a> 内连接和外连接的区别</h4><table><thead><tr><th>JOIN 类型</th><th>返回数据</th></tr></thead><tbody><tr><td>INNER JOIN</td><td>两表都匹配</td></tr><tr><td>LEFT JOIN</td><td>左表全部</td></tr><tr><td>RIGHT JOIN</td><td>右表全部</td></tr><tr><td>FULL JOIN</td><td>两表全部</td></tr></tbody></table><p>题目： 组合两个表</p>',4),u={href:"https://leetcode.cn/problems/combine-two-tables/solutions/3573/zu-he-liang-ge-biao-by-leetcode/",target:"_blank",rel:"noopener noreferrer"},v=o(`<div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code>表: Person
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,9),h={href:"https://leetcode.cn/problems/rank-scores/",target:"_blank",rel:"noopener noreferrer"},_=o(`<div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code>
表: Scores
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="表连接的时候-on和where的区别" tabindex="-1"><a class="header-anchor" href="#表连接的时候-on和where的区别" aria-hidden="true">#</a> 表连接的时候 ON和WHERE的区别</h4><table><thead><tr><th>位置</th><th>作用</th></tr></thead><tbody><tr><td>ON</td><td>定义表之间的匹配关系</td></tr><tr><td>WHERE</td><td>对 JOIN 结果进行过滤</td></tr></tbody></table><p>ON 的功能</p><p>ON 的作用是定义两张表如何匹配。</p><p>例如：</p>`,6),y=s("br",null,null,-1),E=s("br",null,null,-1),N=s("br",null,null,-1),w={href:"http://u.id",target:"_blank",rel:"noopener noreferrer"},g=s("p",null,"含义：",-1),O={href:"http://users.id",target:"_blank",rel:"noopener noreferrer"},R=s("p",null,"ON 定义的是：",-1),S=s("p",null,"表之间的关系",-1),I=s("p",null,"INNER JOIN 时 ON 和 WHERE 的关系",-1),f=s("p",null,"当使用 INNER JOIN 时：",-1),A=s("p",null,"很多时候 ON 和 WHERE 的效果一样。",-1),C=s("p",null,"例如：",-1),B=s("br",null,null,-1),x=s("br",null,null,-1),q=s("br",null,null,-1),L=s("br",null,null,-1),T={href:"http://A.id",target:"_blank",rel:"noopener noreferrer"},D={href:"http://B.id",target:"_blank",rel:"noopener noreferrer"},F=s("br",null,null,-1),Y=s("br",null,null,-1),J=s("br",null,null,-1),H=s("br",null,null,-1),V={href:"http://A.id",target:"_blank",rel:"noopener noreferrer"},W={href:"http://B.id",target:"_blank",rel:"noopener noreferrer"},P=s("p",null,"结果通常一样。",-1),M=s("p",null,"因为：",-1),K=s("p",null,"INNER JOIN 只保留匹配行",-1);function Q(U,z){const a=l("ExternalLinkIcon");return t(),r("div",null,[d,c(" more "),k,s("p",null,[s("a",u,[n("https://leetcode.cn/problems/combine-two-tables/solutions/3573/zu-he-liang-ge-biao-by-leetcode/"),e(a)])]),v,s("p",null,[n("题目： "),s("a",m,[n("https://leetcode.cn/problems/second-highest-salary/"),e(a)])]),b,s("p",null,[s("a",h,[n("https://leetcode.cn/problems/rank-scores/"),e(a)])]),_,s("p",null,[n("SELECT *"),y,n(" FROM users u"),E,n(" JOIN orders o"),N,n(" ON "),s("a",w,[n("u.id"),e(a)]),n(" = o.user_id;")]),g,s("p",null,[s("a",O,[n("users.id"),e(a)]),n(" 和 orders.user_id 相等时才连接")]),R,S,I,f,A,C,s("p",null,[n("写法1"),B,n(" SELECT *"),x,n(" FROM A"),q,n(" JOIN B"),L,n(" ON "),s("a",T,[n("A.id"),e(a)]),n(" = "),s("a",D,[n("B.id"),e(a)]),n(";"),F,n(" 写法2"),Y,n(" SELECT *"),J,n(" FROM A, B"),H,n(" WHERE "),s("a",V,[n("A.id"),e(a)]),n(" = "),s("a",W,[n("B.id"),e(a)]),n(";")]),P,M,K])}const X=p(i,[["render",Q],["__file","sql.html.vue"]]);export{X as default};
